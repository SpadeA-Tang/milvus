...
func TestInsertCodec(t *testing.T) {
	...
	insertDataEmpty := &InsertData{
		Data: map[int64]FieldData{
			...
			StructSubInt32Field:       &ArrayFieldData{ElementType: schemapb.DataType_Int32, Data: []*schemapb.ScalarField{}},
			ArrayField:                &ArrayFieldData{ElementType: schemapb.DataType_Int32, Data: []*schemapb.ScalarField{}},

...
func TestInsertCodec(t *testing.T) {
	...
	insertData1 := &InsertData{
		Data: map[int64]FieldData{
			...
			StructSubFloatVectorField: &ArrayVectorFieldData{
				Dim:         2,
				ElementType: schemapb.DataType_FloatVector,
	...
	insertDataEmpty := &InsertData{
		Data: map[int64]FieldData{
			...
			StructSubFloatVectorField: &ArrayVectorFieldData{0, schemapb.DataType_FloatVector, []*schemapb.VectorField{}},
		},
	}
	...
	for _, v := range resultData.Data[StructSubFloatVectorField].(*ArrayVectorFieldData).Data {
...
func TestAddFieldDataToPayload(t *testing.T) {
	...
	assert.Error(t, err)
	err = AddFieldDataToPayload(e, schemapb.DataType_ArrayOfVector, &ArrayVectorFieldData{
		Dim:         2,
		ElementType: schemapb.DataType_FloatVector,
		Data: []*schemapb.VectorField{
			{

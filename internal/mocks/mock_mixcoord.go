...
func (_m *MixCoord) CreateNestedIndex(_a0 context.Context, _a1 *indexpb.CreateNestedIndexRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)
...
// MixCoord_CreateNestedIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateNestedIndex'
type MixCoord_CreateNestedIndex_Call struct {
	*mock.Call
}
...
func (_e *MixCoord_Expecter) CreateNestedIndex(_a0 interface{}, _a1 interface{}) *MixCoord_CreateNestedIndex_Call {
	return &MixCoord_CreateNestedIndex_Call{Call: _e.mock.On("CreateNestedIndex", _a0, _a1)}
}

func (_c *MixCoord_CreateNestedIndex_Call) Run(run func(_a0 context.Context, _a1 *indexpb.CreateNestedIndexRequest)) *MixCoord_CreateNestedIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MixCoord_CreateNestedIndex_Call) Return(_a0 *commonpb.Status, _a1 error) *MixCoord_CreateNestedIndex_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MixCoord_CreateNestedIndex_Call) RunAndReturn(run func(context.Context, *indexpb.CreateNestedIndexRequest) (*commonpb.Status, error)) *MixCoord_CreateNestedIndex_Call {
	_c.Call.Return(run)
	return _c
}

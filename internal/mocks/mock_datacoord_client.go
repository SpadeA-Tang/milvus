...
// CreateNestedIndex provides a mock function with given fields: ctx, in, opts
func (_m *MockDataCoordClient) CreateNestedIndex(ctx context.Context, in *indexpb.CreateNestedIndexRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateNestedIndex")
	}

	var r0 *commonpb.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *indexpb.CreateNestedIndexRequest, ...grpc.CallOption) (*commonpb.Status, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *indexpb.CreateNestedIndexRequest, ...grpc.CallOption) *commonpb.Status); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *indexpb.CreateNestedIndexRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockDataCoordClient_CreateNestedIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateNestedIndex'
type MockDataCoordClient_CreateNestedIndex_Call struct {
	*mock.Call
}

// CreateNestedIndex is a helper method to define mock.On call
//   - ctx context.Context
//   - in *indexpb.CreateNestedIndexRequest
//   - opts ...grpc.CallOption
func (_e *MockDataCoordClient_Expecter) CreateNestedIndex(ctx interface{}, in interface{}, opts ...interface{}) *MockDataCoordClient_CreateNestedIndex_Call {
	return &MockDataCoordClient_CreateNestedIndex_Call{Call: _e.mock.On("CreateNestedIndex",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockDataCoordClient_CreateNestedIndex_Call) Run(run func(ctx context.Context, in *indexpb.CreateNestedIndexRequest, opts ...grpc.CallOption)) *MockDataCoordClient_CreateNestedIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*indexpb.CreateNestedIndexRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockDataCoordClient_CreateNestedIndex_Call) Return(_a0 *commonpb.Status, _a1 error) *MockDataCoordClient_CreateNestedIndex_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataCoordClient_CreateNestedIndex_Call) RunAndReturn(run func(context.Context, *indexpb.CreateNestedIndexRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockDataCoordClient_CreateNestedIndex_Call {
	_c.Call.Return(run)
	return _c
}

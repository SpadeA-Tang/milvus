...
func (_m *MockMixCoordClient) CreateNestedIndex(ctx context.Context, in *indexpb.CreateNestedIndexRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockMixCoordClient_CreateNestedIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateNestedIndex'
type MockMixCoordClient_CreateNestedIndex_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockMixCoordClient_Expecter) CreateNestedIndex(ctx interface{}, in interface{}, opts ...interface{}) *MockMixCoordClient_CreateNestedIndex_Call {
	return &MockMixCoordClient_CreateNestedIndex_Call{Call: _e.mock.On("CreateNestedIndex",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockMixCoordClient_CreateNestedIndex_Call) Run(run func(ctx context.Context, in *indexpb.CreateNestedIndexRequest, opts ...grpc.CallOption)) *MockMixCoordClient_CreateNestedIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockMixCoordClient_CreateNestedIndex_Call) Return(_a0 *commonpb.Status, _a1 error) *MockMixCoordClient_CreateNestedIndex_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMixCoordClient_CreateNestedIndex_Call) RunAndReturn(run func(context.Context, *indexpb.CreateNestedIndexRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockMixCoordClient_CreateNestedIndex_Call {
	_c.Call.Return(run)
	return _c
}

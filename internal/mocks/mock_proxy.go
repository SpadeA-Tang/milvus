...
func (_m *MockProxy) CreateNestedIndex(_a0 context.Context, _a1 *milvuspb.CreateNestedIndexRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r0 *commonpb.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *milvuspb.CreateNestedIndexRequest) (*commonpb.Status, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *milvuspb.CreateNestedIndexRequest) *commonpb.Status); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *milvuspb.CreateNestedIndexRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// MockProxy_CreateNestedIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateNestedIndex'
type MockProxy_CreateNestedIndex_Call struct {
	*mock.Call
}

// CreateNestedIndex is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 *milvuspb.CreateNestedIndexRequest
func (_e *MockProxy_Expecter) CreateNestedIndex(_a0 interface{}, _a1 interface{}) *MockProxy_CreateNestedIndex_Call {
	return &MockProxy_CreateNestedIndex_Call{Call: _e.mock.On("CreateNestedIndex", _a0, _a1)}
}

func (_c *MockProxy_CreateNestedIndex_Call) Run(run func(_a0 context.Context, _a1 *milvuspb.CreateNestedIndexRequest)) *MockProxy_CreateNestedIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*milvuspb.CreateNestedIndexRequest))
	})
	return _c
}

func (_c *MockProxy_CreateNestedIndex_Call) Return(_a0 *commonpb.Status, _a1 error) *MockProxy_CreateNestedIndex_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockProxy_CreateNestedIndex_Call) RunAndReturn(run func(context.Context, *milvuspb.CreateNestedIndexRequest) (*commonpb.Status, error)) *MockProxy_CreateNestedIndex_Call {
	_c.Call.Return(run)
	return _c
}

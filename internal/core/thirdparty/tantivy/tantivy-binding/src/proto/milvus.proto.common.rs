...
impl ObjectPrivilege {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::PrivilegeAddCollectionFunction => "PrivilegeAddCollectionFunction",
            Self::PrivilegeAlterCollectionFunction => "PrivilegeAlterCollectionFunction",
            Self::PrivilegeDropCollectionFunction => "PrivilegeDropCollectionFunction",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "PrivilegeAddCollectionFunction" => {
                Some(Self::PrivilegeAddCollectionFunction)
            }
            "PrivilegeAlterCollectionFunction" => {
                Some(Self::PrivilegeAlterCollectionFunction)
            }
            "PrivilegeDropCollectionFunction" => {
                Some(Self::PrivilegeDropCollectionFunction)
            }
            "PrivilegeUpdateReplicateConfiguration" => {

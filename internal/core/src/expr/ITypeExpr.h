...
struct ColumnInfo {
    ...
    ColumnInfo(const proto::plan::ColumnInfo& column_info)
        : field_id_(column_info.field_id()),
          ...
          is_element_level_(column_info.is_element_level()) {
    }
    ...
    operator==(const ColumnInfo& other) {
        ...
        if (is_element_level_ != other.is_element_level_) {
            return false;
        }
    ...
    operator<(const ColumnInfo& other) const {
        return std::tie(field_id_,
                        ...
                        nested_path_,
                        nullable_,
                        is_element_level_) < std::tie(other.field_id_,
                                                      other.data_type_,
                                                      other.element_type_,
                                                      other.nested_path_,
                                                      other.nullable_,
                                                      other.is_element_level_);
    }

...
class PhyMatchAllFilterExpr : public SegmentExpr {
 public:
    ...
    MoveCursor() override {
        if (!has_offset_input_) {
            predicate_expr_->MoveCursor();
        }
    }

    bool
    SupportOffsetInput() override {
        return predicate_expr_->SupportOffsetInput();
    }
    ...
    GetColumnInfo() const override {
        return milvus::expr::ColumnInfo(expr_->get_column_info());
    }

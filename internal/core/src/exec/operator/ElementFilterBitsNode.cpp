...
const double DOC_HIT_RATIO_THRESHOLD = 0.01;
...
PhyElementFilterBitsNode::GetOutput() {
    ...
    std::cout << "debug=== PhyElementFilterBitsNode::GetOutput total_cost: "
              << total_cost / 1000.0 << " ms" << std::endl;
...
PhyElementFilterBitsNode::EvaluateElementExpression(
    ...
    if (doc_hit_ratio < DOC_HIT_RATIO_THRESHOLD) {
        ...
        TargetBitmap valid_bitset(total_elements, true);
        // TODO: handle valid_bitset properly

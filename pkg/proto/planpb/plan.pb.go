...
type TantivyLogicalExpr_Op int32

const (
	TantivyLogicalExpr_AND TantivyLogicalExpr_Op = 0
	TantivyLogicalExpr_OR  TantivyLogicalExpr_Op = 1
)

// Enum value maps for TantivyLogicalExpr_Op.
var (
	TantivyLogicalExpr_Op_name = map[int32]string{
		0: "AND",
		1: "OR",
	}
	TantivyLogicalExpr_Op_value = map[string]int32{
		"AND": 0,
		"OR":  1,
	}
)

func (x TantivyLogicalExpr_Op) Enum() *TantivyLogicalExpr_Op {
	p := new(TantivyLogicalExpr_Op)
	*p = x
	return p
}

func (x TantivyLogicalExpr_Op) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TantivyLogicalExpr_Op) Descriptor() protoreflect.EnumDescriptor {
	return file_plan_proto_enumTypes[12].Descriptor()
}

func (TantivyLogicalExpr_Op) Type() protoreflect.EnumType {
	return &file_plan_proto_enumTypes[12]
}

func (x TantivyLogicalExpr_Op) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TantivyLogicalExpr_Op.Descriptor instead.
func (TantivyLogicalExpr_Op) EnumDescriptor() ([]byte, []int) {
...
type ColumnInfo struct {
	...
	IsElementAccess bool              `protobuf:"varint,10,opt,name=is_element_access,json=isElementAccess,proto3" json:"is_element_access,omitempty"` // True when accessing array element (e.g., e[intField] in MATCH_ALL)
}
...
func (x *ColumnInfo) GetIsElementAccess() bool {
	if x != nil {
		return x.IsElementAccess
	}
	return false
}
...
type Expr_MatchExpr struct {
	MatchExpr *MatchExpr `protobuf:"bytes,19,opt,name=match_expr,json=matchExpr,proto3,oneof"`
}
...
type TantivyQueryExpr struct {
	...
	// Types that are assignable to Expr:
	//
	//	*TantivyQueryExpr_Condition
	//	*TantivyQueryExpr_Logical
	Expr isTantivyQueryExpr_Expr `protobuf_oneof:"expr"`
}

func (x *TantivyQueryExpr) Reset() {
	*x = TantivyQueryExpr{}
	if protoimpl.UnsafeEnabled {
...
func (x *TantivyQueryExpr) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TantivyQueryExpr) ProtoMessage() {}

func (x *TantivyQueryExpr) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TantivyQueryExpr.ProtoReflect.Descriptor instead.
func (*TantivyQueryExpr) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{31}
}

func (m *TantivyQueryExpr) GetExpr() isTantivyQueryExpr_Expr {
	if m != nil {
		return m.Expr
	}
	return nil
...
func (x *TantivyQueryExpr) GetCondition() *TantivyFieldCondition {
	if x, ok := x.GetExpr().(*TantivyQueryExpr_Condition); ok {
		return x.Condition
	}
	return nil
}

func (x *TantivyQueryExpr) GetLogical() *TantivyLogicalExpr {
	if x, ok := x.GetExpr().(*TantivyQueryExpr_Logical); ok {
		return x.Logical
	}
	return nil
}

type isTantivyQueryExpr_Expr interface {
	isTantivyQueryExpr_Expr()
}

type TantivyQueryExpr_Condition struct {
	Condition *TantivyFieldCondition `protobuf:"bytes,1,opt,name=condition,proto3,oneof"`
}

type TantivyQueryExpr_Logical struct {
	Logical *TantivyLogicalExpr `protobuf:"bytes,2,opt,name=logical,proto3,oneof"`
}

func (*TantivyQueryExpr_Condition) isTantivyQueryExpr_Expr() {}

func (*TantivyQueryExpr_Logical) isTantivyQueryExpr_Expr() {}

type TantivyFieldCondition struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*TantivyFieldCondition_TermI64
	//	*TantivyFieldCondition_TermF64
	//	*TantivyFieldCondition_TermBool
	//	*TantivyFieldCondition_TermKeyword
	//	*TantivyFieldCondition_RangeI64
	//	*TantivyFieldCondition_RangeF64
	//	*TantivyFieldCondition_RangeKeyword
	ConditionType isTantivyFieldCondition_ConditionType `protobuf_oneof:"condition_type"`
}

func (x *TantivyFieldCondition) Reset() {
	*x = TantivyFieldCondition{}
	if protoimpl.UnsafeEnabled {
...
func (x *TantivyFieldCondition) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TantivyFieldCondition) ProtoMessage() {}

func (x *TantivyFieldCondition) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TantivyFieldCondition.ProtoReflect.Descriptor instead.
func (*TantivyFieldCondition) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{32}
}

func (x *TantivyFieldCondition) GetFieldName() string {
	if x != nil {
		return x.FieldName
	}
	return ""
...
func (m *TantivyFieldCondition) GetConditionType() isTantivyFieldCondition_ConditionType {
	if m != nil {
...
func (x *TantivyFieldCondition) GetTermI64() int64 {
	if x, ok := x.GetConditionType().(*TantivyFieldCondition_TermI64); ok {
		return x.TermI64
	}
	return 0
}

func (x *TantivyFieldCondition) GetTermF64() float64 {
	if x, ok := x.GetConditionType().(*TantivyFieldCondition_TermF64); ok {
		return x.TermF64
	}
	return 0
}

func (x *TantivyFieldCondition) GetTermBool() bool {
	if x, ok := x.GetConditionType().(*TantivyFieldCondition_TermBool); ok {
		return x.TermBool
	}
	return false
}

func (x *TantivyFieldCondition) GetTermKeyword() string {
	if x, ok := x.GetConditionType().(*TantivyFieldCondition_TermKeyword); ok {
		return x.TermKeyword
	}
	return ""
}

func (x *TantivyFieldCondition) GetRangeI64() *TantivyRangeI64 {
	if x, ok := x.GetConditionType().(*TantivyFieldCondition_RangeI64); ok {
		return x.RangeI64
	}
	return nil
}

func (x *TantivyFieldCondition) GetRangeF64() *TantivyRangeF64 {
	if x, ok := x.GetConditionType().(*TantivyFieldCondition_RangeF64); ok {
		return x.RangeF64
	}
	return nil
}

func (x *TantivyFieldCondition) GetRangeKeyword() *TantivyRangeKeyword {
	if x, ok := x.GetConditionType().(*TantivyFieldCondition_RangeKeyword); ok {
		return x.RangeKeyword
	}
	return nil
}

type isTantivyFieldCondition_ConditionType interface {
	isTantivyFieldCondition_ConditionType()
}

type TantivyFieldCondition_TermI64 struct {
	TermI64 int64 `protobuf:"varint,2,opt,name=term_i64,json=termI64,proto3,oneof"`
}

type TantivyFieldCondition_TermF64 struct {
	TermF64 float64 `protobuf:"fixed64,3,opt,name=term_f64,json=termF64,proto3,oneof"`
}

type TantivyFieldCondition_TermBool struct {
	TermBool bool `protobuf:"varint,4,opt,name=term_bool,json=termBool,proto3,oneof"`
}

type TantivyFieldCondition_TermKeyword struct {
	TermKeyword string `protobuf:"bytes,5,opt,name=term_keyword,json=termKeyword,proto3,oneof"`
}

type TantivyFieldCondition_RangeI64 struct {
	RangeI64 *TantivyRangeI64 `protobuf:"bytes,6,opt,name=range_i64,json=rangeI64,proto3,oneof"`
}

type TantivyFieldCondition_RangeF64 struct {
	RangeF64 *TantivyRangeF64 `protobuf:"bytes,7,opt,name=range_f64,json=rangeF64,proto3,oneof"`
}

type TantivyFieldCondition_RangeKeyword struct {
	RangeKeyword *TantivyRangeKeyword `protobuf:"bytes,8,opt,name=range_keyword,json=rangeKeyword,proto3,oneof"`
}

func (*TantivyFieldCondition_TermI64) isTantivyFieldCondition_ConditionType() {}

func (*TantivyFieldCondition_TermF64) isTantivyFieldCondition_ConditionType() {}

func (*TantivyFieldCondition_TermBool) isTantivyFieldCondition_ConditionType() {}

func (*TantivyFieldCondition_TermKeyword) isTantivyFieldCondition_ConditionType() {}

func (*TantivyFieldCondition_RangeI64) isTantivyFieldCondition_ConditionType() {}

func (*TantivyFieldCondition_RangeF64) isTantivyFieldCondition_ConditionType() {}

func (*TantivyFieldCondition_RangeKeyword) isTantivyFieldCondition_ConditionType() {}

type TantivyLogicalExpr struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Op       TantivyLogicalExpr_Op `protobuf:"varint,1,opt,name=op,proto3,enum=milvus.proto.plan.TantivyLogicalExpr_Op" json:"op,omitempty"`
	Children []*TantivyQueryExpr   `protobuf:"bytes,2,rep,name=children,proto3" json:"children,omitempty"`
}

func (x *TantivyLogicalExpr) Reset() {
	*x = TantivyLogicalExpr{}
	if protoimpl.UnsafeEnabled {
...
func (x *TantivyLogicalExpr) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TantivyLogicalExpr) ProtoMessage() {}

func (x *TantivyLogicalExpr) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[33]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TantivyLogicalExpr.ProtoReflect.Descriptor instead.
func (*TantivyLogicalExpr) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{33}
}

func (x *TantivyLogicalExpr) GetOp() TantivyLogicalExpr_Op {
	if x != nil {
		return x.Op
	}
	return TantivyLogicalExpr_AND
}

func (x *TantivyLogicalExpr) GetChildren() []*TantivyQueryExpr {
	if x != nil {
		return x.Children
	}
	return nil
...
type TantivyRangeI64 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Lower          *int64 `protobuf:"varint,1,opt,name=lower,proto3,oneof" json:"lower,omitempty"`
	Upper          *int64 `protobuf:"varint,2,opt,name=upper,proto3,oneof" json:"upper,omitempty"`
...
func (x *TantivyRangeI64) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TantivyRangeI64) ProtoMessage() {}

func (x *TantivyRangeI64) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TantivyRangeI64.ProtoReflect.Descriptor instead.
func (*TantivyRangeI64) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{34}
}

func (x *TantivyRangeI64) GetLower() int64 {
...
func (x *TantivyRangeI64) GetUpper() int64 {
...
func (x *TantivyRangeI64) GetLowerInclusive() bool {
	if x != nil {
		return x.LowerInclusive
	}
	return false
...
func (x *TantivyRangeI64) GetUpperInclusive() bool {
	if x != nil {
		return x.UpperInclusive
	}
	return false
...
func (x *TantivyRangeF64) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TantivyRangeF64) ProtoMessage() {}

func (x *TantivyRangeF64) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[35]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TantivyRangeF64.ProtoReflect.Descriptor instead.
func (*TantivyRangeF64) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{35}
}

func (x *TantivyRangeF64) GetLower() float64 {
	if x != nil && x.Lower != nil {
		return *x.Lower
	}
	return 0
...
func (x *TantivyRangeF64) GetUpper() float64 {
	if x != nil && x.Upper != nil {
		return *x.Upper
	}
	return 0
...
func (x *TantivyRangeF64) GetLowerInclusive() bool {
	if x != nil {
		return x.LowerInclusive
	}
	return false
...
func (x *TantivyRangeF64) GetUpperInclusive() bool {
	if x != nil {
		return x.UpperInclusive
	}
	return false
...
type TantivyRangeKeyword struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Lower          *string `protobuf:"bytes,1,opt,name=lower,proto3,oneof" json:"lower,omitempty"`
	Upper          *string `protobuf:"bytes,2,opt,name=upper,proto3,oneof" json:"upper,omitempty"`
	LowerInclusive bool    `protobuf:"varint,3,opt,name=lower_inclusive,json=lowerInclusive,proto3" json:"lower_inclusive,omitempty"`
	UpperInclusive bool    `protobuf:"varint,4,opt,name=upper_inclusive,json=upperInclusive,proto3" json:"upper_inclusive,omitempty"`
}

func (x *TantivyRangeKeyword) Reset() {
	*x = TantivyRangeKeyword{}
	if protoimpl.UnsafeEnabled {
...
func (x *TantivyRangeKeyword) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TantivyRangeKeyword) ProtoMessage() {}

func (x *TantivyRangeKeyword) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TantivyRangeKeyword.ProtoReflect.Descriptor instead.
func (*TantivyRangeKeyword) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{36}
}

func (x *TantivyRangeKeyword) GetLower() string {
	if x != nil && x.Lower != nil {
		return *x.Lower
	}
	return ""
...
func (x *TantivyRangeKeyword) GetUpper() string {
	if x != nil && x.Upper != nil {
		return *x.Upper
	}
	return ""
...
func (x *TantivyRangeKeyword) GetLowerInclusive() bool {
	if x != nil {
		return x.LowerInclusive
	}
	return false
...
func (x *TantivyRangeKeyword) GetUpperInclusive() bool {
	if x != nil {
		return x.UpperInclusive
	}
	return false
...
var file_plan_proto_rawDesc = []byte{
	...
	0xa7, 0x03, 0x0a, 0x0a, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x19,
	...
	0x01, 0x28, 0x08, 0x52, 0x08, 0x6e, 0x75, 0x6c, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x2a, 0x0a,
	0x11, 0x69, 0x73, 0x5f, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x69, 0x73, 0x45, 0x6c, 0x65, 0x6d,
	0x65, 0x6e, 0x74, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x3f, 0x0a, 0x0a, 0x43, 0x6f, 0x6c,
	0x75, 0x6d, 0x6e, 0x45, 0x78, 0x70, 0x72, 0x12, 0x31, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x3f, 0x0a, 0x0a, 0x45, 0x78,
	0x69, 0x73, 0x74, 0x73, 0x45, 0x78, 0x70, 0x72, 0x12, 0x31, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f,
	...
	0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x78, 0x0a, 0x09, 0x56,
	0x61, 0x6c, 0x75, 0x65, 0x45, 0x78, 0x70, 0x72, 0x12, 0x35, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	...
	0x34, 0x0a, 0x16, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x5f, 0x76, 0x61, 0x72, 0x69,
	0x61, 0x62, 0x6c, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x14, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c,
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xac, 0x02, 0x0a, 0x0e, 0x55, 0x6e, 0x61, 0x72, 0x79, 0x52,
	0x61, 0x6e, 0x67, 0x65, 0x45, 0x78, 0x70, 0x72, 0x12, 0x3e, 0x0a, 0x0b, 0x63, 0x6f, 0x6c, 0x75,
	...
	0x6c, 0x75, 0x6d, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x29, 0x0a, 0x02, 0x6f, 0x70, 0x18, 0x02,
	...
	0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x34, 0x0a, 0x16, 0x74, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x75, 0x6d, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x37, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65,
	...
	0x12, 0x1e, 0x0a, 0x0b, 0x69, 0x73, 0x5f, 0x69, 0x6e, 0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x73, 0x49, 0x6e, 0x46, 0x69, 0x65, 0x6c, 0x64,
	...
	0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xf6, 0x02, 0x0a, 0x10, 0x4a, 0x53, 0x4f, 0x4e, 0x43,
	0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x73, 0x45, 0x78, 0x70, 0x72, 0x12, 0x3e, 0x0a, 0x0b, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x2e,
	0x47, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x0c, 0x72, 0x69,
	0x67, 0x68, 0x74, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x6e, 0x64, 0x12, 0x29, 0x0a, 0x02, 0x6f, 0x70,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x4f, 0x70, 0x54, 0x79, 0x70,
	0x65, 0x52, 0x02, 0x6f, 0x70, 0x12, 0x35, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x05,
	...
	,
	...
	0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xe8, 0x0b, 0x0a, 0x04, 0x45, 0x78, 0x70,
	...
	0x43, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x65, 0x45, 0x78, 0x70, 0x72, 0x12, 0x3d, 0x0a, 0x0a, 0x6d,
	0x61, 0x74, 0x63, 0x68, 0x5f, 0x65, 0x78, 0x70, 0x72, 0x18, 0x13, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x42, 0x06, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x6e, 0x61, 0x6d,
	0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x2a, 0xea, 0x01, 0x0a, 0x06, 0x4f, 0x70, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x0b, 0x0a, 0x07, 0x49, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x10, 0x00, 0x12, 0x0f,
	...
	,
	...
	,
...
var file_plan_proto_goTypes = []interface{}{
	...
	(FunctionType)(0),                   // 4: milvus.proto.plan.FunctionType
	(FunctionMode)(0),                   // 5: milvus.proto.plan.FunctionMode
	(BoostMode)(0),                      // 6: milvus.proto.plan.BoostMode
	(JSONContainsExpr_JSONOp)(0),        // 7: milvus.proto.plan.JSONContainsExpr.JSONOp
	(NullExpr_NullOp)(0),                // 8: milvus.proto.plan.NullExpr.NullOp
	(GISFunctionFilterExpr_GISOp)(0),    // 9: milvus.proto.plan.GISFunctionFilterExpr.GISOp
	(UnaryExpr_UnaryOp)(0),              // 10: milvus.proto.plan.UnaryExpr.UnaryOp
	(BinaryExpr_BinaryOp)(0),            // 11: milvus.proto.plan.BinaryExpr.BinaryOp
	(TantivyLogicalExpr_Op)(0),          // 12: milvus.proto.plan.TantivyLogicalExpr.Op
	...
	(*AlwaysTrueExpr)(nil),              // 35: milvus.proto.plan.AlwaysTrueExpr
	(*Interval)(nil),                    // 36: milvus.proto.plan.Interval
	(*TimestamptzArithCompareExpr)(nil), // 37: milvus.proto.plan.TimestamptzArithCompareExpr
	(*MatchExpr)(nil),                   // 38: milvus.proto.plan.MatchExpr
	(*Expr)(nil),                        // 39: milvus.proto.plan.Expr
	(*VectorANNS)(nil),                  // 40: milvus.proto.plan.VectorANNS
	(*QueryPlanNode)(nil),               // 41: milvus.proto.plan.QueryPlanNode
	(*ScoreFunction)(nil),               // 42: milvus.proto.plan.ScoreFunction
	(*ScoreOption)(nil),                 // 43: milvus.proto.plan.ScoreOption
	(*TantivyQueryExpr)(nil),            // 44: milvus.proto.plan.TantivyQueryExpr
	(*TantivyFieldCondition)(nil),       // 45: milvus.proto.plan.TantivyFieldCondition
	(*TantivyLogicalExpr)(nil),          // 46: milvus.proto.plan.TantivyLogicalExpr
	(*TantivyRangeI64)(nil),             // 47: milvus.proto.plan.TantivyRangeI64
	(*TantivyRangeF64)(nil),             // 48: milvus.proto.plan.TantivyRangeF64
	(*TantivyRangeKeyword)(nil),         // 49: milvus.proto.plan.TantivyRangeKeyword
	(*PlanOption)(nil),                  // 50: milvus.proto.plan.PlanOption
	(*PlanNode)(nil),                    // 51: milvus.proto.plan.PlanNode
	(schemapb.DataType)(0),              // 52: milvus.proto.schema.DataType
...
var file_plan_proto_depIdxs = []int32{
	...
	52, // 2: milvus.proto.plan.Array.element_type:type_name -> milvus.proto.schema.DataType
	15, // 3: milvus.proto.plan.QueryInfo.search_iterator_v2_info:type_name -> milvus.proto.plan.SearchIteratorV2Info
	52, // 4: milvus.proto.plan.QueryInfo.json_type:type_name -> milvus.proto.schema.DataType
	52, // 5: milvus.proto.plan.ColumnInfo.data_type:type_name -> milvus.proto.schema.DataType
	52, // 6: milvus.proto.plan.ColumnInfo.element_type:type_name -> milvus.proto.schema.DataType
	...
	39, // 17: milvus.proto.plan.CallExpr.function_parameters:type_name -> milvus.proto.plan.Expr
	...
	7,  // 25: milvus.proto.plan.JSONContainsExpr.op:type_name -> milvus.proto.plan.JSONContainsExpr.JSONOp
	17, // 26: milvus.proto.plan.NullExpr.column_info:type_name -> milvus.proto.plan.ColumnInfo
	8,  // 27: milvus.proto.plan.NullExpr.op:type_name -> milvus.proto.plan.NullExpr.NullOp
	17, // 28: milvus.proto.plan.GISFunctionFilterExpr.column_info:type_name -> milvus.proto.plan.ColumnInfo
	9,  // 29: milvus.proto.plan.GISFunctionFilterExpr.op:type_name -> milvus.proto.plan.GISFunctionFilterExpr.GISOp
	10, // 30: milvus.proto.plan.UnaryExpr.op:type_name -> milvus.proto.plan.UnaryExpr.UnaryOp
	39, // 31: milvus.proto.plan.UnaryExpr.child:type_name -> milvus.proto.plan.Expr
	11, // 32: milvus.proto.plan.BinaryExpr.op:type_name -> milvus.proto.plan.BinaryExpr.BinaryOp
	39, // 33: milvus.proto.plan.BinaryExpr.left:type_name -> milvus.proto.plan.Expr
	39, // 34: milvus.proto.plan.BinaryExpr.right:type_name -> milvus.proto.plan.Expr
	...
	39, // 38: milvus.proto.plan.BinaryArithExpr.left:type_name -> milvus.proto.plan.Expr
	39, // 39: milvus.proto.plan.BinaryArithExpr.right:type_name -> milvus.proto.plan.Expr
	...
	39, // 46: milvus.proto.plan.RandomSampleExpr.predicate:type_name -> milvus.proto.plan.Expr
	17, // 47: milvus.proto.plan.TimestamptzArithCompareExpr.timestamptz_column:type_name -> milvus.proto.plan.ColumnInfo
	1,  // 48: milvus.proto.plan.TimestamptzArithCompareExpr.arith_op:type_name -> milvus.proto.plan.ArithOpType
	36, // 49: milvus.proto.plan.TimestamptzArithCompareExpr.interval:type_name -> milvus.proto.plan.Interval
	0,  // 50: milvus.proto.plan.TimestamptzArithCompareExpr.compare_op:type_name -> milvus.proto.plan.OpType
	13, // 51: milvus.proto.plan.TimestamptzArithCompareExpr.compare_value:type_name -> milvus.proto.plan.GenericValue
	39, // 52: milvus.proto.plan.MatchExpr.predicate:type_name -> milvus.proto.plan.Expr
	3,  // 53: milvus.proto.plan.MatchExpr.match_type:type_name -> milvus.proto.plan.MatchType
	25, // 54: milvus.proto.plan.Expr.term_expr:type_name -> milvus.proto.plan.TermExpr
	29, // 55: milvus.proto.plan.Expr.unary_expr:type_name -> milvus.proto.plan.UnaryExpr
	30, // 56: milvus.proto.plan.Expr.binary_expr:type_name -> milvus.proto.plan.BinaryExpr
	24, // 57: milvus.proto.plan.Expr.compare_expr:type_name -> milvus.proto.plan.CompareExpr
	21, // 58: milvus.proto.plan.Expr.unary_range_expr:type_name -> milvus.proto.plan.UnaryRangeExpr
	22, // 59: milvus.proto.plan.Expr.binary_range_expr:type_name -> milvus.proto.plan.BinaryRangeExpr
	33, // 60: milvus.proto.plan.Expr.binary_arith_op_eval_range_expr:type_name -> milvus.proto.plan.BinaryArithOpEvalRangeExpr
	32, // 61: milvus.proto.plan.Expr.binary_arith_expr:type_name -> milvus.proto.plan.BinaryArithExpr
	20, // 62: milvus.proto.plan.Expr.value_expr:type_name -> milvus.proto.plan.ValueExpr
	18, // 63: milvus.proto.plan.Expr.column_expr:type_name -> milvus.proto.plan.ColumnExpr
	19, // 64: milvus.proto.plan.Expr.exists_expr:type_name -> milvus.proto.plan.ExistsExpr
	35, // 65: milvus.proto.plan.Expr.always_true_expr:type_name -> milvus.proto.plan.AlwaysTrueExpr
	26, // 66: milvus.proto.plan.Expr.json_contains_expr:type_name -> milvus.proto.plan.JSONContainsExpr
	23, // 67: milvus.proto.plan.Expr.call_expr:type_name -> milvus.proto.plan.CallExpr
	27, // 68: milvus.proto.plan.Expr.null_expr:type_name -> milvus.proto.plan.NullExpr
	34, // 69: milvus.proto.plan.Expr.random_sample_expr:type_name -> milvus.proto.plan.RandomSampleExpr
	28, // 70: milvus.proto.plan.Expr.gisfunction_filter_expr:type_name -> milvus.proto.plan.GISFunctionFilterExpr
	37, // 71: milvus.proto.plan.Expr.timestamptz_arith_compare_expr:type_name -> milvus.proto.plan.TimestamptzArithCompareExpr
	38, // 72: milvus.proto.plan.Expr.match_expr:type_name -> milvus.proto.plan.MatchExpr
	2,  // 73: milvus.proto.plan.VectorANNS.vector_type:type_name -> milvus.proto.plan.VectorType
	39, // 74: milvus.proto.plan.VectorANNS.predicates:type_name -> milvus.proto.plan.Expr
	16, // 75: milvus.proto.plan.VectorANNS.query_info:type_name -> milvus.proto.plan.QueryInfo
	39, // 76: milvus.proto.plan.QueryPlanNode.predicates:type_name -> milvus.proto.plan.Expr
	39, // 77: milvus.proto.plan.ScoreFunction.filter:type_name -> milvus.proto.plan.Expr
	4,  // 78: milvus.proto.plan.ScoreFunction.type:type_name -> milvus.proto.plan.FunctionType
	53, // 79: milvus.proto.plan.ScoreFunction.params:type_name -> milvus.proto.common.KeyValuePair
	6,  // 80: milvus.proto.plan.ScoreOption.boost_mode:type_name -> milvus.proto.plan.BoostMode
	5,  // 81: milvus.proto.plan.ScoreOption.function_mode:type_name -> milvus.proto.plan.FunctionMode
	45, // 82: milvus.proto.plan.TantivyQueryExpr.condition:type_name -> milvus.proto.plan.TantivyFieldCondition
	46, // 83: milvus.proto.plan.TantivyQueryExpr.logical:type_name -> milvus.proto.plan.TantivyLogicalExpr
	47, // 84: milvus.proto.plan.TantivyFieldCondition.range_i64:type_name -> milvus.proto.plan.TantivyRangeI64
	48, // 85: milvus.proto.plan.TantivyFieldCondition.range_f64:type_name -> milvus.proto.plan.TantivyRangeF64
	49, // 86: milvus.proto.plan.TantivyFieldCondition.range_keyword:type_name -> milvus.proto.plan.TantivyRangeKeyword
	12, // 87: milvus.proto.plan.TantivyLogicalExpr.op:type_name -> milvus.proto.plan.TantivyLogicalExpr.Op
	44, // 88: milvus.proto.plan.TantivyLogicalExpr.children:type_name -> milvus.proto.plan.TantivyQueryExpr
	40, // 89: milvus.proto.plan.PlanNode.vector_anns:type_name -> milvus.proto.plan.VectorANNS
	39, // 90: milvus.proto.plan.PlanNode.predicates:type_name -> milvus.proto.plan.Expr
	41, // 91: milvus.proto.plan.PlanNode.query:type_name -> milvus.proto.plan.QueryPlanNode
	42, // 92: milvus.proto.plan.PlanNode.scorers:type_name -> milvus.proto.plan.ScoreFunction
	50, // 93: milvus.proto.plan.PlanNode.plan_options:type_name -> milvus.proto.plan.PlanOption
	43, // 94: milvus.proto.plan.PlanNode.score_option:type_name -> milvus.proto.plan.ScoreOption
...
func file_plan_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_plan_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TantivyFieldCondition); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_plan_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TantivyLogicalExpr); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_plan_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TantivyRangeKeyword); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_plan_proto_msgTypes[31].OneofWrappers = []interface{}{
		(*TantivyQueryExpr_Condition)(nil),
		(*TantivyQueryExpr_Logical)(nil),
	}
	file_plan_proto_msgTypes[32].OneofWrappers = []interface{}{
		(*TantivyFieldCondition_TermI64)(nil),
		(*TantivyFieldCondition_TermF64)(nil),
		(*TantivyFieldCondition_TermBool)(nil),
		(*TantivyFieldCondition_TermKeyword)(nil),
		(*TantivyFieldCondition_RangeI64)(nil),
		(*TantivyFieldCondition_RangeF64)(nil),
		(*TantivyFieldCondition_RangeKeyword)(nil),
	}
	...
	file_plan_proto_msgTypes[38].OneofWrappers = []interface{}{

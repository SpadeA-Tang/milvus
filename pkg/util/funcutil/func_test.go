...
func (s *NumRowsWithSchemaSuite) SetupSuite() {
	schema := &schemapb.CollectionSchema{
		Fields: []*schemapb.FieldSchema{
			...
			{FieldID: 116, Name: "array_vector_float16", IsStructField: true, DataType: schemapb.DataType_Array, ElementType: schemapb.DataType_Float16Vector, TypeParams: []*commonpb.KeyValuePair{{Key: "dim", Value: "4"}}},
		...
		},
		{
			...
			input: &schemapb.FieldData{
				...
				Field: &schemapb.FieldData_Vectors{
					Vectors: &schemapb.VectorField{
						Dim: 4,
						Data: &schemapb.VectorField_ArrayVector{ArrayVector: &schemapb.ArrayVector{Data: []*schemapb.VectorField{
							{
								Dim:  4,

...
def analyze_and_save_sentence_distributions(dfs: List[pd.DataFrame],
                                            output_dir: str = os.path.join(RESULTS_DIR, "train_data_analysis")) -> Dict:
...
def prepare_data(host="127.0.0.1", port=19530, minio_host="127.0.0.1", bucket_name="milvus-bucket", data_size=1000000):
    ...
    fields = [
        ...
        FieldSchema(name="word", dtype=DataType.VARCHAR, max_length=65535, enable_match=True, enable_analyzer=True,
                    analyzer_params=analyzer_params),
        FieldSchema(name="sentence", dtype=DataType.VARCHAR, max_length=65535, enable_match=True, enable_analyzer=True,
                    analyzer_params=analyzer_params),
...
if __name__ == "__main__":
    ...
    prepare_data(host=args.host, port=args.port, minio_host=args.minio_host, data_size=args.data_size,

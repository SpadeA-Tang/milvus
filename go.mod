...
replace (
	...
	github.com/milvus-io/milvus-proto/go-api/v2 v2.6.4-0.20251013093953-f3e0a710c654 => github.com/SpadeA-Tang/milvus-proto/go-api/v2 v2.0.0-20251106071021-df3827f8f56b
